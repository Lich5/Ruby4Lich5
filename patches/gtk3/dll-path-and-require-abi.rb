...
# gtk3 -- vendored-DLL path + ABI-qualified require, same shape as
# glib2/cairo/gobject-introspection/gio2/pango's equivalent patches, anchor
# inside loader.rb's require_extension method.
